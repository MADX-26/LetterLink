...
class GameConsumer(AsyncWebsocketConsumer):
    ...
    def check_words(self, room):
        ...
        dictionary = [
            ...
            "ANY","APE","ARC","ARM","ART","ASH","ASK","AWE","AXE","BAD",
            "BAG","BAR","BAT","BAY","BED","BEE","BET","BID","BIG","BIN",
            "BIT","BOG","BOX","BOY","BUN","BUS","BUT","CAB","CAN","CAP",
            "CAR","CAT","CUP","CUT","DAD","DAM","DAY","DEN","DIG","DIM",
            "DIN","DIP","DOG","DOT","DRY","DUE","EAR","EAT","EGG","END",
            "ERA","EYE","FAN","FAR","FAT","FAX","FED","FEW","FIG","FIN",
            "FIT","FIX","FLY","FOG","FOX","FUN","FUR","GAP","GAS","GEM",
            "GET","GIN","GOD","GOT","GUM","GUN","GUY","GYM","HAM","HAT",
            "HAY","HEM","HEN","HER","HID","HIM","HIP","HIT","HOG","HOP",
            "HOT","HUB","HUG","HUT","ICE","INK","JAM","JAR","JET","JOB",
            "JOG","JOY","JUG","KEY","KID","KIT","LAB","LAD","LAG","LAP",
            "LAW","LEG","LET","LID","LIE","LIP","LOG","LOT","MAD","MAN",
            "MAP","MAT","MAY","MET","MIX","MOB","MOM","MOP","MUD","MUG",
            "NAP","NET","NEW","NOD","NOT","NOW","NUT","OAK","ODD","OFF",
            "OIL","OLD","ONE","ORB","OUT","OWL","OWN","PAD","PAN","PAT",
            "PAY","PEN","PET","PIG","PIN","PIT","POT","PRO","PUB","PUP",
            "PUT","RAG","RAM","RAN","RAP","RAT","RAW","RED","RIB","RID",
            "RIM","RIP","ROD","ROT","ROW","RUB","RUG","RUN","SAD","SAT",
            "SAW","SEA","SET","SEW","SHE","SHY","SIP","SIR","SIT","SIX",
            "SKY","SLY","SON","SUN","TAB","TAG","TAN","TAP","TAR","TEA",
            "TEN","THE","TIP","TOE","TON","TOP","TOY","TRY","TUB","TUG",
            "TWO","USE","VAN","WAR","WAS","WAX","WAY","WEB","WET","WHO",
            "WHY","WIN","WON","WOW","YAK","YAM","YES","YOU","ZIP","ZOO",
            ...
            "MERE","MILE","MILK","MIND","MINE","MISS","MODE","MOOD","MOON",
            ...
            "RAID","RAIL","RAIN","RANK","RATE","READ","REAL","REAR","RELY",
            ...
            "THAT","THEM","THEN","THEY","THIN","THIS","TIME","TINY","TOLD",
            "TOLL","TONE","TOOK","TOOL","TOUR","TOWN","TREE","TRIP","TRUE",
            "TUNE","TURN","TYPE","UNIT","UPON","USED","USER","VARY","VAST",
            "VERY","VICE","VIEW","VOTE","WAGE","WAIT","WAKE","WALK","WALL",
            "WANT","WARD","WARM","WASH","WAVE","WEAK","WEAR","WEEK","WELL",
            ...
            "GRADE","GRAND","GRANT","GRASS","GREEN","GROSS","GROUP","GROWN",
            ...
            "THERE","THESE","THICK","THING","THINK","THIRD","THREE","THREW",
